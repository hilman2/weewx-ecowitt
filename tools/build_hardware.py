...
HEADER = """# Ecowitt hardware

Every device this driver knows about, what it is, and which fields it sends.

The descriptions are written; the field lists come from the catalog, so they cannot
drift apart. Generated by `tools/build_hardware.py`. Do not edit by hand.
